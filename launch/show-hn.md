...
Not distributed. Not streaming SQL (use RisingWave or Materialize for that). Not for event-time watermarks (Flink is better). It's for the smaller use case that doesn't need a platform team.
