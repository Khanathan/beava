...
Welcome! Tally is a real-time feature server: push events in, get features out, one Rust binary, zero infrastructure. See the [README](https://github.com/petrpan26/tally) for an overview.
