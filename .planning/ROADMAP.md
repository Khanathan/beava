...
- [ ] 45-02-PLAN.md — Wave 1 read endpoints: GET /features/{key} with ?table filter, GET /streams, GET /streams/{name}, public-mode routing (HTTP-04/05/07)
...
| 45. HTTP Ingest & Read API | v1.0-launch | 1/5 | In Progress|  |
