...
- [x] **SDK-01**: @st.stream decorator defines a stream with key field and feature declarations
...
- [x] **PERS-03**: Server loads latest snapshot on startup for crash recovery
