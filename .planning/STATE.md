...
status: "Phase 12.9 CLOSED 2026-05-03 (PASS); v0 critical path = Phase 13 final ship NEXT"
...
**v0 critical path post-pivot (refreshed 2026-05-03):** ~~Plan 12-10 (push-and-get on mio)~~ DEFERRED per Phase 12.6 D-04 → ~~Phase 12.6 (surface reduction)~~ ✅ **CLOSED 2026-04-30 (PASS-WITH-WARN)** → ~~Phase 12.7 (table strip)~~ ✅ **CLOSED 2026-05-01 (PASS)** → ~~Phase 12.8 (memory governance)~~ ✅ **CLOSED 2026-05-01 (PASS-WITH-WARN)** → ~~Phase 12.9 (AggOp memory boxing — fraud-team 22 KB → 6 KB)~~ ✅ **CLOSED 2026-05-03 (PASS)** → **Phase 13 (final v0 ship — SDK polish + perf benchmarks + minimum-viable docs + PyPI/Docker/GitHub Releases) — NEXT**. Phase 25 (session windows) and Phase 26 (Valkey IO rework) are v0.1+. Phases 14/14.1/15 are dead architecture — do not unarchive without explicit user override + new ADR.
