# Tally v2.1 Launch — Active Roadmap

**Status (2026-04-14):** ACTIVE. v0 restructure **complete** (Phase 26
sign-off 11/11 green on 2026-04-14 — see
`.planning/phases/26-test-migration-bench-docs-demo/26-SIGNOFF.md`).
Phase 20 artifacts ported to the v0 SDK (generator.py / replay_30d.py /
demo UI / smoke.sh) under plan 26-03. Deploy-ready: no re-provision
needed; the four protected deploy files (tally.service, Caddyfile,
provision.sh, README.md) are untouched and API-agnostic by design.

**Resume instructions:** see
`.planning/phases/26-test-migration-bench-docs-demo/26-04-SUMMARY.md`
("Resuming v2.1 Launch" section).
