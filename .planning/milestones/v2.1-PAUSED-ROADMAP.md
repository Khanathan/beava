...
**Status update (2026-04-14):** v0 restructure complete (Phase 26 sign-off
pending 26-04). Phase 20 artifacts ported to the v0 SDK (generator.py /
replay_30d.py / demo UI / smoke.sh) under plan 26-03. Deploy-ready: no
re-provision needed; the four protected deploy files (tally.service,
Caddyfile, provision.sh, README.md) are untouched and API-agnostic by
design. Resume instructions land in 26-04-SUMMARY.md.
